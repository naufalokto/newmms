...
<body>
    ...
    @if($services->count() > 0)
        ...
        @endforeach
    @else
        <div class="service-list-row" style="display: grid; grid-template-columns: 1fr; align-items: center; justify-items: center; width: 100%; max-width: 1100px; margin: 0 auto 1.9rem auto; padding: 2rem 40px; min-height: 100px; border-bottom: 1px solid #eee;">
