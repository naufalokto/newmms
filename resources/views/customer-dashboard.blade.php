        ...
        function renderPendingTestimonialCards() {
            ...
            .then(data => {
                ...
                if (!data.eligible_services || data.eligible_services.length === 0) {
                    cardsDiv.innerHTML = `<div style='text-align:center;color:#888;font-family:Poppins,sans-serif;font-size:1.05rem;margin:2rem 0;'>Tidak ada testimoni yang perlu diisi.</div>`;
                    return;
                }
